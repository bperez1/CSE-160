...
class Vector3 {
    ...
    add(other) {
        ...
        let v3Elem = this.elements;
        let v4Elem = other.elements;
    ...
    static dot(other1, other2) {
        let v1Elem = other1.elements;
        let v2Elem = other2.elements;
        
        let d = (v1Elem[0] * v2Elem[0]) + (v1Elem[1] * v2Elem[1]) + (v1Elem[2] * v2Elem[2]);
    ...
    static cross(other1, other2) {
        ...
        let x = (v1Elem[1] * v2Elem[2]) - (v2Elem[1] * v1Elem[2]);
        let y = (v1Elem[2] * v2Elem[0]) - (v2Elem[2] * v1Elem[0]);
        let z = (v1Elem[0] * v2Elem[1]) - (v2Elem[0] * v1Elem[1]);
    ...
    magnitude() {
        ...
        let x = vElem[0];
        let y = vElem[1];
        let z = vElem[2]; // didn't scale it earlier

        if(z == 0){ // for the scaled versions done by the live version not the tests
          x = vElem[0]/20;
          y = vElem[1]/20;
        }

        let m = Math.sqrt(Math.pow(x,2) + Math.pow(y,2) + Math.pow(z,2)); // Modify this line to calculate this vector's magnitude.
