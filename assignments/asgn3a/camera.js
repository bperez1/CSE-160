class Camera {
    constructor(canvas) {
        ...
        this.near = 0.1;
        this.far = 1000;
        this.eye = new Vector3([0.25, 0, -3]);  // Initial eye position
        this.at = new Vector3([0.25001, 0, 0]);  // Adjusted to ensure a forward vector with a slight vertical component
